...
// Contiguous Substring Count

// We are given a string S, we need to find the count of
// all contiguous substrings starting and ending with the same character.
...
public class ContiguousSubstrings { // TC : O(2 ^ n), SC : O(n)

    // Method to count the number of contiguous substrings of length 'n' in the string 'str'
    ...
    // Main method to demonstrate the countSubstrs function
